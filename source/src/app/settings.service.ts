...
export class SettingsService {
  ...
  skills = [
    { name: 'GIS', progress: 90, style: 'green' },
    { name: 'C/C++', progress: 75, style: 'default' },
    ...
    { name: 'TypeScript', progress: 95, style: 'blue' },
    ...
    { name: 'Angular', progress: 90, style: 'red' },
  ...
  update(obj: any) {
    ...
    for (const key in obj)
      if (this.hasOwnProperty(key) && typeof obj[key] === 'object')
        if (key === 'social') {
          for (const k in obj[key]) if (this[key][k]) Object.assign(this[key][k], obj[key][k]);
        } else Object.assign(this[key], obj[key]);
  }
}
